require([
    ...
    function updateTitle(countryValue) {
        var newTitle = '';
        var titleField = $('#payment_other_openpay_banks_title'); // <-- USA EL ID QUE ENCONTRASTE
    ...
    $(document).ready(function () {
        ...
        var countrySelector = $('#payment_other_openpay_banks_country'); // <-- USA EL ID QUE ENCONTRASTE
